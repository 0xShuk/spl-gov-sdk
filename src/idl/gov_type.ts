  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "tokenOwnerOrSignatory",
          "isMut": false,
          "isSigner": false,
          "docs": [
            "Either TokenOwnerRecord account of the proposal owner or the RequiredSignatory\n        account associated with the governance."
          ]
        },
        {
          "name": "governanceAuthority",
          ...
          "isOptional": true,
          "docs": [
            "Governance Authority (Token Owner or Governance Delegate).\n        Required if TokenOwnerRecord is provided as the previous account."
          ]
        }
      ],
      "args": [
